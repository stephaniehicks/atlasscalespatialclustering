...
```{r}
seurat_ls <- stage_1(seurat_ls,preprocess = T, top_pcs = 8, cor_threshold = 0.6, edge_smoothing = T, nn = 6, use_glmpca = T)

ElbowPlot(seurat_ls[["151507"]])


rtn_ls <- stage_2(seurat_ls, cl_key = "merged_cluster",rtn_seurat = T,nn_2 = 10,method = "MNN",top_pcs = 8, use_glmpca = T, rare_ct = "m")
seurat_ls <- assign_label(seurat_ls, rtn_ls$cl_df, "MNN", cl_key = "merged_cluster")
